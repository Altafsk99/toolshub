...
export function PdfMultiUploader({
  onFilesSelected,
  error,
  label = "Drop PDF files",
  hint = "Or click to browse. Add two or more PDFs — processed entirely in your browser.",
}: PdfMultiUploaderProps) {
  ...
  return (
    <div className="w-full">
      ...
      >
        <p className="font-display text-2xl font-semibold text-ink sm:text-3xl">{label}</p>
        <p className="mt-2 max-w-md text-sm leading-relaxed text-ink-soft/80">{hint}</p>
