...
export function PdfSingleUploader({
  onFileSelected,
  error,
  label = "Drop a PDF",
  hint = "Or click to browse. Your file stays on this device — nothing is uploaded.",
}: PdfSingleUploaderProps) {
