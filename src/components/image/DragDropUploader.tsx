  ...
  return (
    <div className="w-full">
      <motion.button
        ...
        className={`focus-ring group relative w-full overflow-hidden rounded-[var(--radius-lg)] border border-dashed px-4 py-10 text-left transition sm:px-6 sm:py-14 ${
          isDragging
